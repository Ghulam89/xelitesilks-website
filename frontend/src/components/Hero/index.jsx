    ...
    <div className="relative">
      ...
      >
        {slides.map((slide, idx) => (
          <SwiperSlide key={idx}>
            <div className="bg-cover bg-[#f7f3ef] px-3 sm:px-0 bg-center">
              <div className="flex md:flex-row gap-2 flex-col mx-auto max-w-7xl items-center justify-between min-h-[80vh]">
                <div className="sm:w-5/12 w-full pt-3 text-white">
                  <p
                    className={`md:text-6xl text-4xl font-bold mt-2 mb-4 ${
                      activeIndex === idx ? 'opacity-0 animate-slide-up' : ''
                    }`}
                    style={
                      activeIndex === idx
                  ...
                  <p
                    className={`sm:text-lg text-base mt-3 mb-6 ${
                      activeIndex === idx ? 'opacity-0 animate-fade-in' : ''
                    }`}
                    style={
                      activeIndex === idx
                ...
                <div className="sm:w-7/12 w-full">
                  <img src={slide.img} className="w-full" alt={`Slide ${idx + 1}`} />
                </div>
              </div>
            </div>
          </SwiperSlide>
